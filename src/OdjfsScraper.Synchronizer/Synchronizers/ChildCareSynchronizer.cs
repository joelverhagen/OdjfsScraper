...
namespace OdjfsScraper.Synchronizer.Synchronizers
{
    public class ChildCareSynchronizer : IChildCareSynchronizer
    {
        ...
        private async Task UpdateChildCareOrStub(Entities ctx, Func<IQueryable<ChildCareStub>, Task<ChildCareStub>> childCareStubSelector, Func<IQueryable<ChildCare>, Task<ChildCare>> childCareSelector)
        {
