...
namespace OdjfsScraper.Exporter.Support
{
    public class DetailedChildCareSrdsSchema : ISrdsSchema<DetailedChildCare>
    {
        private static readonly IEnumerable<SrdsAttribute<DetailedChildCare>> Properties = new List<SrdsAttribute<DetailedChildCare>>
        {
            ...
            new SrdsAttribute<DetailedChildCare>("MondayBegin", "DateTime?", c => c.MondayBegin),
            new SrdsAttribute<DetailedChildCare>("MondayEnd", "DateTime?", c => c.MondayEnd),
            new SrdsAttribute<DetailedChildCare>("TuesdayReported", "System.Boolean", c => c.TuesdayReported),
            new SrdsAttribute<DetailedChildCare>("TuesdayBegin", "DateTime?", c => c.TuesdayBegin),
            new SrdsAttribute<DetailedChildCare>("TuesdayEnd", "DateTime?", c => c.TuesdayEnd),
            new SrdsAttribute<DetailedChildCare>("WednesdayReported", "System.Boolean", c => c.WednesdayReported),
            new SrdsAttribute<DetailedChildCare>("WednesdayBegin", "DateTime?", c => c.WednesdayBegin),
            new SrdsAttribute<DetailedChildCare>("WednesdayEnd", "DateTime?", c => c.WednesdayEnd),
            new SrdsAttribute<DetailedChildCare>("ThursdayReported", "System.Boolean", c => c.ThursdayReported),
            new SrdsAttribute<DetailedChildCare>("ThursdayBegin", "DateTime?", c => c.ThursdayBegin),
            new SrdsAttribute<DetailedChildCare>("ThursdayEnd", "DateTime?", c => c.ThursdayEnd),
            new SrdsAttribute<DetailedChildCare>("FridayReported", "System.Boolean", c => c.FridayReported),
            new SrdsAttribute<DetailedChildCare>("FridayBegin", "DateTime?", c => c.FridayBegin),
            new SrdsAttribute<DetailedChildCare>("FridayEnd", "DateTime?", c => c.FridayEnd),
            new SrdsAttribute<DetailedChildCare>("SaturdayReported", "System.Boolean", c => c.SaturdayReported),
            new SrdsAttribute<DetailedChildCare>("SaturdayBegin", "DateTime?", c => c.SaturdayBegin),
            new SrdsAttribute<DetailedChildCare>("SaturdayEnd", "DateTime?", c => c.SaturdayEnd),
            new SrdsAttribute<DetailedChildCare>("SundayReported", "System.Boolean", c => c.SundayReported),
            new SrdsAttribute<DetailedChildCare>("SundayBegin", "DateTime?", c => c.SundayBegin),
            new SrdsAttribute<DetailedChildCare>("SundayEnd", "DateTime?", c => c.SundayEnd),
        }.AsReadOnly();
